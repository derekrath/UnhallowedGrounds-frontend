...
const NavBar = ({ title }) => {
  ...
  const list = (anchor) => (
    <Box
      sx={{ backgroundColor: "#121217", height: "100%", width: anchor === "top" || anchor === "bottom" ? "auto" : 250 }}
      role="presentation"
    ...
    >
      ...
      >
        <ThemeProvider theme={theme}>
          ...
          <Divider sx={{backgroundColor: "#494a4b", width:"100%"}}/>
          <List>
            <Box>
              <Link to={`/Contact`}>
                <Button>
            ...
            <ThemeProvider theme={theme}>
              ...
              {/* <Link to={`/cart`}> */}
                <React.Fragment key={"left"}>
                  <Button
                    startIcon={<MenuIcon style={{ fontSize: 36, color: "#494a4b" }} />}
            ...
            <ThemeProvider theme={theme}>
                ...
                <Link to={`/cart`}>
                  <Button
                    startIcon={
                      ...
                      >
                        <ShoppingBagIcon style={{ fontSize: 36, color: "#494a4b" }} />
                      </Badge>
                    }
                  />
                </Link>
              ...
              <div>
                ...
                <Button onClick={handleMenuClick}>
                  <AccountCircleIcon style={{ fontSize: 36, color: "#494a4b" }} />
                </Button>
                <Menu
                  anchorEl={anchorEl}
